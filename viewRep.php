   ...
   <!-- Cars in the database for dealer -->
...
else if(isset($_SESSION['salesrep1']))
            ...
            
    {
        $dbconnect = mysqli_connect("127.0.0.1", "root", "", "dealer_one");
            ...
            $query3 = "SELECT * FROM representative WHERE rep_no = 'S91364' ";
            ...
            
    {
        $dbconnect = mysqli_connect("127.0.0.1", "root", "", "dealer_two");
          ...
          // $id = $_POST['sale_no'];
           $id = $_SESSION['id'];
            ...
            $query4 = "SELECT * FROM sales_person WHERE sale_no = '$id' ";
        ...
        if(($output1->num_rows != 0)){
           ...
           ?>
              ...
              <?php } } else if(($output3->num_rows != 0)){ 
              ...
              <?php } } else if(($output4->num_rows != 0)){ 

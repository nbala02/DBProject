...
<html>
    ...
    <body>
        ...
        <div id="enter car">
            <form method="post" action="entercars_sql_TEST.php">
                <table border="0">
                    <tr>
                    <td for="serial_no" id="cell">Serial NO:</td>
                    <td><input type="text" name="model" id="model" placeholder="Enter serial no for car" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="warehouse" name="warehouse" id="warehouse" placeholder="Enter warehouse" required></td>
                    </tr>
                    <tr id="submit">
                        <td>&nbsp;</td>

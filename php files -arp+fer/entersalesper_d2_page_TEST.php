...
<html>
    ...
    <body>
        ...
        <div id="enter car">
            <form method="post" action="entersalesper_d2_sql_TEST.php">
                <table border="0">
                    <tr>
                    <td for="sale_no" id="cell">Sale NO:</td>
                    <td><input type="text" name="sale_no" id="sale_no" placeholder="Enter number of sales person" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <tr>
                        <td for="ytdsales" id="cell">Year-to-date:</td>
                        <td><input type="ytdsales" name="ytdsales" id="ytdsales" placeholder="Enter Year-to-date sales" required></td>
                    </tr>

						...
						<table> 
                            <thead class="table100-head">
								<tr class="row100 head">
                                    <th class="cell100 column1">Dealer No</th>
                                    <th class="cell100 column2">Rebate No</th>
                                    <th class="cell100 column3">Representative No</th>
                                    <th class="cell100 column2">Customer No</th>
                                    <th class="cell100 column2">Serial No</th>
         ...
         ?>
                                ...
                                <form method=POST >
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column2"><?php echo "<input style=text-align:center;type=text name=rep_no
                                        value='".$result['rep_no']."'>"?></td>
                                        <td class="cell100 column2"><?php echo "<input style=text-align:center;type=text name=customer_no value='".$result['customer_no']."'>"?></td>
                                        <td class="cell100 column2"><?php echo "<input style=text-align:center; type=text name=serial_no
                                    value='".$result['serial_no']."'>"?>\</td>

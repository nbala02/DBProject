...
<html>
    ...
    <body>
        ...
        <div id="enter transaction">
            <form method="post" action="entertransaction_d1_sql_TEST.php">
                <table border="0">
                 <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="rep_no" id="rep_no" placeholder="Enter Representative No" required></td>
                </tr>
                    <tr>
                        <td for="customer_no" id="cell">Customer No:</td>
                        <td><input type="text" name="customer_no" id="customer_no" placeholder="Enter Customer No" required></td>
                    </tr>
                     <tr>
                        <td for="serial_no" id="cell">Serial No:</td>
                        <td><input type="text" name="serial_no" id="serial_no" placeholder="Enter Serial No" required></td>
                    </tr>
                    <tr>
